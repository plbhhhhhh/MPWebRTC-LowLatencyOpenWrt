...
class RtpPacketToSend : public RtpPacket {
 public:
  static constexpr int kNoPathHint = -1;
  static constexpr int kPrimaryPathHint = 0;
  static constexpr int kSecondaryPathHint = 1;
  ...
  // Indicates whether the packet payload format is explicitly H264.
  void set_is_h264(bool is_h264) { is_h264_ = is_h264; }
  bool is_h264() const { return is_h264_; }
  ...
  int path_hint() const { return path_hint_; }
  void set_path_hint(int path_hint) { path_hint_ = path_hint; }
