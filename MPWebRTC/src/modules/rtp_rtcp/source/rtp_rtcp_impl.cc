...
void ModuleRtpRtcpImpl::SetFecProtectionParamsForPathHint(
    int /*path_hint*/,
    const FecProtectionParams& delta_params,
    const FecProtectionParams& key_params) {
  SetFecProtectionParams(delta_params, key_params);
}
...
RtpSendRates ModuleRtpRtcpImpl::GetSendRatesByPathHint(
    int /*path_hint*/) const {
  return GetSendRates();
}
