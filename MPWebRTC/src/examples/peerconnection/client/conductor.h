...
class Conductor : public webrtc::PeerConnectionObserver,
 ...
 protected:
  ...
  void AddTracks();
  void StartMetricsLoggingIfNeeded();
 ...
 protected:
  ...
  std::string server_;
  std::atomic<bool> metrics_logging_active_{false};
  std::thread metrics_logging_thread_;
  webrtc::scoped_refptr<webrtc::RTCStatsCollectorCallback> metrics_logger_;
};
