...
MediaChannelUtil::TransportForMediaChannels::TranslatePacketOptions(
  ...
  rtc_options.first_packet_in_batch = options.first_packet_in_batch;
  rtc_options.last_packet_in_batch = options.last_packet_in_batch;
  rtc_options.packet_priority = options.packet_priority;
  rtc_options.probe_cluster_id = options.probe_cluster_id;
  rtc_options.batch_duration_ms = options.batch_duration_ms;
  rtc_options.path_hint = options.path_hint;
  return rtc_options;
}
